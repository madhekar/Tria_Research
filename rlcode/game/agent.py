...
def train():
   ...
   while True:
      ...
      state_o = agent.get_state(game)
      #print('1:', state_o)
      #get move
      final_move = agent.get_action(state_o)
      #print('2:', final_move)
      ...
      #train short memory
      agent.train_short_memory(state_o, final_move, reward, state_new, done )

      # store in memory
      agent.remember(state_o, final_move, reward, state_new, done )
